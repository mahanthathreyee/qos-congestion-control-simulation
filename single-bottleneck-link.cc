...
int main(int argc, char* argv[]) {
    ...
    // Right Nodes
    NodeContainer r1c0 = NodeContainer(routers.Get(1), sinkNodes.Get(0));
    ...
    NetDeviceContainer rd1cd0 = nodeRouterLink.Install(r1c0);
    ...
    Ipv4InterfaceContainer regLinkInterface_rd1cd0 = ipv4.Assign(rd1cd0);
    ...
    Address sinkAddress4(
        InetSocketAddress(regLinkInterface_rd1cd0.GetAddress(1), sinkPort));
